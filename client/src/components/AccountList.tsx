...
const AccountList = ({ accounts, onDisconnect }: AccountListProps) => {
  ...
  // Show this when no accounts are connected
...
//                   <span className="size-4 text-amber-600">Disconnected</span>
//                 </>
//               )}
//             </div>
...
//               onClick={()=>handleDisconnect(account._id)}
//               title="Disconnect Account"
//               className="m1-2 p-1.5 rounded-lg text-slate-300 group-hover:text-red-500 transition-all">
//                 <UnplugIcon className="size-4"/>
//               </button>
